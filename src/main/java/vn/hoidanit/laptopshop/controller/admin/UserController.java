...
public class UserController {
    ...
    public String getCreatePage(Model model, @ModelAttribute("newUser") @Valid User suthy, BindingResult bindingResult,
    ...
    public String postUpdateUser(Model model, @ModelAttribute("newUser") User suthy) {
        ...
        if (currentUser != null) {
            ...
            currentUser.setRole(this.userService.getRoleByName(suthy.getRole().getName()));
